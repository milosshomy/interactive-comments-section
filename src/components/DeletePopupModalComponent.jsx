const DeletePopupModalComponent = ({ repliedCommentContainer, modal }) => {
  ...
  function removeComment(event) {
    const modal = event.target.offsetParent;
    modal.style.display = "none";
    repliedCommentContainer.current.style.display = "none";
  }
...
export default DeletePopupModalComponent;
